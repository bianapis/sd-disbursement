 ...
 * DisbursementWithId
 */
public class DisbursementWithId   {
  private String productInstanceReference = null;

  private String disbursementInstructionReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier        
   * @return disbursementInstructionReference
  **/

  public String getDisbursementInstructionReference() {
    return disbursementInstructionReference;
  }

  public void setDisbursementInstructionReference(String disbursementInstructionReference) {
    this.disbursementInstructionReference = disbursementInstructionReference;
  }
